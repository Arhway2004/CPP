...
void playGame()
{
    ...
    world.addWildPokemon(WildPokemon("AKEee", "Akeeeke!", "Fire", 55, 50, 65));
    world.addWildPokemon(WildPokemon("Pectchy", "Powwwww!", "Water", 48, 65, 63));
    world.addWildPokemon(WildPokemon("Kaeeee", "Tyyyyyyy!", "Normal", 46, 20, 40));
    ...
    while ((world.checkMon()  && player.checkPokeballs2()) || first_time)
    {
        ...
        case 1:
            ...
            cout << "Five Pok̩balls added to your inventory." << endl;
            first_time = false;
            break;}
            else{
